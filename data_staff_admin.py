...
'''
saya ingin mengumpulkan data nama, alamat, kota asal staff admin
'''
...
while True:
    nama = input("Masukkan nama lengkap staff admin \t: ")
    nama = nama.upper()

    alamat = input('Masukkan alamat staff admin  \t: ')
    alamat = alamat.upper()

    kota_asal = input('Masukkan kota asal staff admin : ')
